...
public abstract class AbstractC8026dcc extends NetflixFrag {
    private boolean b;
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC8040dcq) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).b((UserMarksFragment) UnsafeCasts.unsafeCast(this));
    }
}
