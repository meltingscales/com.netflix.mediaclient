...
public abstract class AbstractC6526cev<T> extends AbstractC9971zz<T> {
    private boolean a;
    private boolean d;
    private ContextWrapper e;

    public AbstractC6526cev(long j, boolean z, ViewGroup.LayoutParams layoutParams, Integer num, boolean z2) {
        super(j, z, layoutParams, num, z2);
        this.d = false;
    }
    ...
    public void inject() {
        ...
        this.d = true;
        ((InterfaceC6511ceg) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).a((ContinueWatchingMenuDialogFragment) UnsafeCasts.unsafeCast(this));
    }
}
