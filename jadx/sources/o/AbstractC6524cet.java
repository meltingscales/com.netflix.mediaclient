...
public abstract class AbstractC6524cet extends NetflixDialogFrag {
    ...
    public void inject() {
        ...
        this.a = true;
        ((InterfaceC6480ceB) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).e((QuickDrawDialogFrag) UnsafeCasts.unsafeCast(this));
    }
}
