...
public abstract class AbstractC7045col extends NetflixFrag {
    private boolean b;
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC7043coj) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).c((MyListFragmentTab) UnsafeCasts.unsafeCast(this));
    }
}
