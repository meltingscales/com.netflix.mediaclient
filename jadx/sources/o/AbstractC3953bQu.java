...
public abstract class AbstractC3953bQu extends bMX {
    private boolean b;
    ...
    public void bf_() {
        ...
        this.j = true;
        ((bQG) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).c((bQD) UnsafeCasts.unsafeCast(this));
    }
}
