...
public abstract class AbstractC3725bIi extends bMX {
    private boolean b;
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC3720bId) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).e((FullDpFrag) UnsafeCasts.unsafeCast(this));
    }
}
