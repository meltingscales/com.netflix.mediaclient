...
public abstract class AbstractC4154bYf extends bMX {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC4165bYq) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).b((KidsCharacterFrag) UnsafeCasts.unsafeCast(this));
    }
}
