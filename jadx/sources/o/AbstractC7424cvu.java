...
public abstract class AbstractC7424cvu extends NetflixFrag {
    private boolean b;
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC7420cvq) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).d((DownloadedForYouSettingsFragment) UnsafeCasts.unsafeCast(this));
    }
}
