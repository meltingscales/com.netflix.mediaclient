...
public abstract class AbstractC5992cPz extends NetflixFrag {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((cPB) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).b((ProfileViewingRestrictionsFragment) UnsafeCasts.unsafeCast(this));
    }
}
