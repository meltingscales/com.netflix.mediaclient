...
public abstract class bPW extends bMX {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((bPQ) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).b((GdpFragment) UnsafeCasts.unsafeCast(this));
    }
}
