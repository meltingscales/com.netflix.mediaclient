...
public abstract class bTM extends bMX {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC4046bUf) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).e((LolomoMvRxFragment) UnsafeCasts.unsafeCast(this));
    }
}
