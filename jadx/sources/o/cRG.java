...
public abstract class cRG extends NetflixFrag {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((cRU) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).a((SearchSuggestionOnNapaFragment) UnsafeCasts.unsafeCast(this));
    }
}
