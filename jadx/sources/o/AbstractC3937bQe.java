...
public abstract class AbstractC3937bQe extends NetflixDialogFrag {
    ...
    public void inject() {
        ...
        this.a = true;
        ((InterfaceC3936bQd) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).a((InstallInterstitialFragment) UnsafeCasts.unsafeCast(this));
    }
}
