...
public abstract class cLU extends NetflixFrag {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC5925cNl) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).a((ProfileDetailsFragment) UnsafeCasts.unsafeCast(this));
    }
}
