...
public abstract class AbstractC7162cqx extends NetflixFrag {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC7117cqE) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).c((MultiTitleNotificationsFrag) UnsafeCasts.unsafeCast(this));
    }
}
