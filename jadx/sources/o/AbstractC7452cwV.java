...
public abstract class AbstractC7452cwV extends NetflixFrag {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC7553cyQ) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).d((PlayerFragmentV2) UnsafeCasts.unsafeCast(this));
    }
}
