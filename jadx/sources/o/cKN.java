...
public abstract class cKN extends NetflixFrag {
    private boolean b;
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC5861cLb) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).c((cKP) UnsafeCasts.unsafeCast(this));
    }
}
