...
public abstract class cLQ extends NetflixFrag {
    ...
    public void bf_() {
        ...
        this.j = true;
        ((cLF) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).b((AddProfileFragment) UnsafeCasts.unsafeCast(this));
    }
}
