...
public abstract class AbstractC6741ciy extends NetflixFrag {
    private boolean b;
    ...
    public void bf_() {
        ...
        this.j = true;
        ((InterfaceC6701ciK) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).d((MoreFragment) UnsafeCasts.unsafeCast(this));
    }
}
