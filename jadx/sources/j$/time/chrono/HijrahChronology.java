...
public final class HijrahChronology extends AbstractC8521dor implements Serializable {
    public static final HijrahChronology c;
    ...
    private transient int f13340o;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: j$.time.chrono.HijrahChronology$5  reason: invalid class name */
    /* loaded from: classes6.dex */
    public static abstract /* synthetic */ class AnonymousClass5 {
        ...
        static {
            ...
            try {
                c[ChronoField.A.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                c[ChronoField.m.ordinal()] = 6;
    ...
    static {
        ...
        c = hijrahChronology;
        AbstractC8521dor.e(hijrahChronology, "Hijrah");
        AbstractC8521dor.e(hijrahChronology, "islamic");
    }
    ...
    private int[] c(int i, int i2, int i3, Map map) {
        int i4 = (((i3 - i2) + 1) * 12) + 1;
        int[] iArr = new int[i4];
        ...
        throw new IllegalStateException("Did not fill epochMonths exactly: ndx = " + i9 + " should be " + i4);
    }
    ...
    private void k() {
        try {
            ...
            int[][] m = m();
            int length = m.length + 1299;
            int l = (int) LocalDate.a(1882, 11, 12).l();
            ...
            this.e = 15600;
            this.i = l;
            int[] c2 = c(l, 1300, length, hashMap);
            this.a = c2;
            this.f = c2[c2.length - 1];
            for (int i2 = 1300; i2 < length; i2++) {
                int e = e(i2);
                this.f13340o = Math.min(this.f13340o, e);
                this.j = Math.max(this.j, e);
            }
        } catch (Exception e2) {
            throw new DateTimeException("Unable to initialize HijrahCalendar: " + this.k, e2);
        }
    }
    ...
    public HijrahDate b(int i, int i2, int i3) {
        return HijrahDate.a(this, i, i2, i3);
    }

    @Override // o.InterfaceC8528doy
    /* renamed from: a */
    public HijrahEra c(int i) {
        if (i == 1) {
            return HijrahEra.AH;
        }
    ...
    public ValueRange a(ChronoField chronoField) {
        ...
        if (chronoField instanceof ChronoField) {
            switch (AnonymousClass5.c[chronoField.ordinal()]) {
                case 1:
                    return ValueRange.b(1L, 1L, j(), f());
                case 2:
                    return ValueRange.b(1L, h());
                case 3:
                    return ValueRange.b(1L, 5L);
                case 4:
                case 5:
                    return ValueRange.b(g(), i());
                case 6:
                    return ValueRange.b(1L, 1L);
                default:
    ...
    @Override // o.InterfaceC8528doy
    public List a() {
        return AbstractC8520doq.a(HijrahEra.values());
    }
    ...
    public HijrahDate e(long j) {
        return HijrahDate.d(this, j);
    }

    public HijrahDate b(Clock clock) {
    ...
    @Override // o.InterfaceC8528doy
    /* renamed from: c */
    public HijrahDate b(int i, int i2) {
        HijrahDate a = HijrahDate.a(this, i, 1, 1);
        if (i2 <= a.k()) {
            return a.c(i2 - 1);
        }
    ...
    @Override // o.InterfaceC8528doy
    /* renamed from: c */
    public HijrahDate b(doY doy) {
        return doy instanceof HijrahDate ? (HijrahDate) doy : HijrahDate.d(this, doy.a(ChronoField.k));
    }

    @Override // o.InterfaceC8528doy
    public boolean c(long j) {
        o();
        return j >= ((long) g()) && j <= ((long) i()) && e((int) j) > 354;
    }
    ...
    public int[] d(int i) {
        ...
        int g = g(i);
        return new int[]{h(g), f(g) + 1, (i - j(g)) + 1};
    }
    ...
    /* renamed from: h */
    public HijrahDate c(Map map, ResolverStyle resolverStyle) {
        return (HijrahDate) super.c(map, resolverStyle);
    }

    int i() {
        return h(this.a.length - 1) - 1;
    }
