...
public final class AutoValue_UiDefinition_Layout_Choice extends C$AutoValue_UiDefinition_Layout_Choice {
    public static final Parcelable.Creator<AutoValue_UiDefinition_Layout_Choice> CREATOR = new Parcelable.Creator<AutoValue_UiDefinition_Layout_Choice>() { // from class: com.netflix.model.leafs.originals.interactive.AutoValue_UiDefinition_Layout_Choice.1
        ...
        public AutoValue_UiDefinition_Layout_Choice createFromParcel(Parcel parcel) {
            return new AutoValue_UiDefinition_Layout_Choice(parcel.readInt() == 0 ? parcel.readString() : null, parcel.readInt() == 0 ? parcel.readString() : null, parcel.readInt() == 0 ? parcel.readString() : null, parcel.readHashMap(UiDefinition.Layout.Choice.class.getClassLoader()), parcel.readHashMap(UiDefinition.Layout.Choice.class.getClassLoader()), (UiDefinition.Layout.Choice.ChoiceChildren) parcel.readParcelable(UiDefinition.Layout.Choice.class.getClassLoader()));
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AutoValue_UiDefinition_Layout_Choice(final String str, final String str2, final String str3, final Map<String, AnimationTemplateId> map, final Map<String, VisualStateDefinition> map2, final UiDefinition.Layout.Choice.ChoiceChildren choiceChildren) {
        new C$$AutoValue_UiDefinition_Layout_Choice(str, str2, str3, map, map2, choiceChildren) { // from class: com.netflix.model.leafs.originals.interactive.$AutoValue_UiDefinition_Layout_Choice
            ...
            public static final class GsonTypeAdapter extends TypeAdapter<UiDefinition.Layout.Choice> {
                ...
                public void write(JsonWriter jsonWriter, UiDefinition.Layout.Choice choice) {
                    ...
                    this.visualStateTransitionsAdapter.write(jsonWriter, choice.visualStateTransitions());
                    jsonWriter.name("visualStates");
                    this.visualStatesAdapter.write(jsonWriter, choice.visualStates());
                ...
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // com.google.gson.TypeAdapter
                public UiDefinition.Layout.Choice read(JsonReader jsonReader) {
                    char c;
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (jsonReader.peek() == JsonToken.NULL) {
                            ...
                            if (c == 0) {
                                ...
                                choiceChildren = this.childrenAdapter.read(jsonReader);
                            } else {
                    ...
                    return new AutoValue_UiDefinition_Layout_Choice(str4, str5, str6, map, map2, choiceChildren);
                }
            }
        };
    }
