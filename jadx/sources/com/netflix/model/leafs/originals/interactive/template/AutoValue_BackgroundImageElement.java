...
public final class AutoValue_BackgroundImageElement extends C$AutoValue_BackgroundImageElement {
    ...
    public AutoValue_BackgroundImageElement(String str, String str2, String str3, Map<String, AnimationTemplateId> map, Map<String, VisualStateDefinition> map2, ImageAssetId imageAssetId, List<BackgroundImageElement.BackgroundImageElementOverride> list) {
        new C$$AutoValue_BackgroundImageElement(str, str2, str3, map, map2, imageAssetId, list) { // from class: com.netflix.model.leafs.originals.interactive.template.$AutoValue_BackgroundImageElement
            ...
            /* loaded from: classes.dex */
            public static final class GsonTypeAdapter extends TypeAdapter<BackgroundImageElement> {
                private final TypeAdapter<ImageAssetId> backgroundImageAdapter;
                private final TypeAdapter<String> idAdapter;
                private final TypeAdapter<List<BackgroundImageElement.BackgroundImageElementOverride>> overridesAdapter;
                ...
                public GsonTypeAdapter setDefaultOverrides(List<BackgroundImageElement.BackgroundImageElementOverride> list) {
                ...
                public GsonTypeAdapter(Gson gson) {
                    ...
                    this.overridesAdapter = gson.getAdapter(TypeToken.getParameterized(List.class, BackgroundImageElement.BackgroundImageElementOverride.class));
                }

                @Override // com.google.gson.TypeAdapter
                public void write(JsonWriter jsonWriter, BackgroundImageElement backgroundImageElement) {
                    ...
                    this.idAdapter.write(jsonWriter, backgroundImageElement.id());
                    jsonWriter.name("type");
                    this.typeAdapter.write(jsonWriter, backgroundImageElement.type());
                    jsonWriter.name("styleId");
                    this.styleIdAdapter.write(jsonWriter, backgroundImageElement.styleId());
                    jsonWriter.name("visualStateTransitions");
                    this.visualStateTransitionsAdapter.write(jsonWriter, backgroundImageElement.visualStateTransitions());
                    jsonWriter.name("visualStates");
                    this.visualStatesAdapter.write(jsonWriter, backgroundImageElement.visualStates());
                    jsonWriter.name("backgroundImage");
                    this.backgroundImageAdapter.write(jsonWriter, backgroundImageElement.backgroundImage());
                    jsonWriter.name("overrides");
                    this.overridesAdapter.write(jsonWriter, backgroundImageElement.overrides());
                ...
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // com.google.gson.TypeAdapter
                public BackgroundImageElement read(JsonReader jsonReader) {
                    char c;
                        ...
                        if (jsonReader.peek() == JsonToken.NULL) {
                            ...
                            switch (c) {
                                ...
                                case 4:
                                    ...
                                    continue;
                                case 5:
                                    imageAssetId = this.backgroundImageAdapter.read(jsonReader);
                                    continue;
                                case 6:
