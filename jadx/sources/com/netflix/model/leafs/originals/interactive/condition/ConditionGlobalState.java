...
public class ConditionGlobalState extends AbstractConditionState {
    public static final Parcelable.Creator<ConditionGlobalState> CREATOR = new Parcelable.Creator<ConditionGlobalState>() { // from class: com.netflix.model.leafs.originals.interactive.condition.ConditionGlobalState.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ConditionGlobalState createFromParcel(Parcel parcel) {
            return new ConditionGlobalState(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ConditionGlobalState[] newArray(int i) {
            return new ConditionGlobalState[i];
        }
    };
    private static final String TAG = "ConditionGlobalState";
    ...
    public ConditionGlobalState(String str) {
        super(str);
    }

    private ConditionGlobalState(Parcel parcel) {
    ...
    public JsonElement getValue(InteractiveMoments interactiveMoments) {
        return interactiveMoments.stateHistory().global().values.get(this.state);
    }
}
