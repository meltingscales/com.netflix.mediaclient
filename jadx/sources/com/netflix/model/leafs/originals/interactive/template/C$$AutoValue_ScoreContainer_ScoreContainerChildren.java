...
/* renamed from: com.netflix.model.leafs.originals.interactive.template.$$AutoValue_ScoreContainer_ScoreContainerChildren  reason: invalid class name */
/* loaded from: classes.dex */
public abstract class C$$AutoValue_ScoreContainer_ScoreContainerChildren extends ScoreContainer.ScoreContainerChildren {
    ...
    @Override // com.netflix.model.leafs.originals.interactive.template.ScoreContainer.ScoreContainerChildren
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C$$AutoValue_ScoreContainer_ScoreContainerChildren(String str, String str2, String str3, Map<String, AnimationTemplateId> map, Map<String, VisualStateDefinition> map2, ImageElement imageElement, SimpleElement simpleElement, SimpleElement simpleElement2, SimpleElement simpleElement3) {
        this.id = str;
        this.type = str2;
        this.styleId = str3;
