...
public final class AutoValue_UnlockContainer_UnlockContainerChildren extends C$AutoValue_UnlockContainer_UnlockContainerChildren {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AutoValue_UnlockContainer_UnlockContainerChildren(final String str, final String str2, final String str3, final Map<String, AnimationTemplateId> map, final Map<String, VisualStateDefinition> map2, final ImageElement imageElement, final SimpleElement simpleElement) {
        new C$$AutoValue_UnlockContainer_UnlockContainerChildren(str, str2, str3, map, map2, imageElement, simpleElement) { // from class: com.netflix.model.leafs.originals.interactive.template.$AutoValue_UnlockContainer_UnlockContainerChildren
            ...
            /* loaded from: classes.dex */
            public static final class GsonTypeAdapter extends TypeAdapter<UnlockContainer.UnlockContainerChildren> {
                ...
                public void write(JsonWriter jsonWriter, UnlockContainer.UnlockContainerChildren unlockContainerChildren) {
                    ...
                    this.idAdapter.write(jsonWriter, unlockContainerChildren.id());
                    jsonWriter.name("type");
                    this.typeAdapter.write(jsonWriter, unlockContainerChildren.type());
                    jsonWriter.name("styleId");
                    this.styleIdAdapter.write(jsonWriter, unlockContainerChildren.styleId());
                    jsonWriter.name("visualStateTransitions");
                    this.visualStateTransitionsAdapter.write(jsonWriter, unlockContainerChildren.visualStateTransitions());
                    jsonWriter.name("visualStates");
                    this.visualStatesAdapter.write(jsonWriter, unlockContainerChildren.visualStates());
                    jsonWriter.name("backgroundImage");
                    this.backgroundImageAdapter.write(jsonWriter, unlockContainerChildren.backgroundImage());
                    jsonWriter.name("label");
                    this.labelAdapter.write(jsonWriter, unlockContainerChildren.label());
                ...
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // com.google.gson.TypeAdapter
                public UnlockContainer.UnlockContainerChildren read(JsonReader jsonReader) {
                    char c;
