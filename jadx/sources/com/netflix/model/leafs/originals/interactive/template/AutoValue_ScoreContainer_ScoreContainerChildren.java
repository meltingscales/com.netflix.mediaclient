...
public final class AutoValue_ScoreContainer_ScoreContainerChildren extends C$AutoValue_ScoreContainer_ScoreContainerChildren {
    public static final Parcelable.Creator<AutoValue_ScoreContainer_ScoreContainerChildren> CREATOR = new Parcelable.Creator<AutoValue_ScoreContainer_ScoreContainerChildren>() { // from class: com.netflix.model.leafs.originals.interactive.template.AutoValue_ScoreContainer_ScoreContainerChildren.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public AutoValue_ScoreContainer_ScoreContainerChildren createFromParcel(Parcel parcel) {
            return new AutoValue_ScoreContainer_ScoreContainerChildren(parcel.readInt() == 0 ? parcel.readString() : null, parcel.readInt() == 0 ? parcel.readString() : null, parcel.readInt() == 0 ? parcel.readString() : null, parcel.readHashMap(ScoreContainer.ScoreContainerChildren.class.getClassLoader()), parcel.readHashMap(ScoreContainer.ScoreContainerChildren.class.getClassLoader()), (ImageElement) parcel.readParcelable(ScoreContainer.ScoreContainerChildren.class.getClassLoader()), (SimpleElement) parcel.readParcelable(ScoreContainer.ScoreContainerChildren.class.getClassLoader()), (SimpleElement) parcel.readParcelable(ScoreContainer.ScoreContainerChildren.class.getClassLoader()), (SimpleElement) parcel.readParcelable(ScoreContainer.ScoreContainerChildren.class.getClassLoader()));
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public AutoValue_ScoreContainer_ScoreContainerChildren[] newArray(int i) {
            return new AutoValue_ScoreContainer_ScoreContainerChildren[i];
        }
    };
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AutoValue_ScoreContainer_ScoreContainerChildren(final String str, final String str2, final String str3, final Map<String, AnimationTemplateId> map, final Map<String, VisualStateDefinition> map2, final ImageElement imageElement, final SimpleElement simpleElement, final SimpleElement simpleElement2, final SimpleElement simpleElement3) {
        new C$$AutoValue_ScoreContainer_ScoreContainerChildren(str, str2, str3, map, map2, imageElement, simpleElement, simpleElement2, simpleElement3) { // from class: com.netflix.model.leafs.originals.interactive.template.$AutoValue_ScoreContainer_ScoreContainerChildren

            /* renamed from: com.netflix.model.leafs.originals.interactive.template.$AutoValue_ScoreContainer_ScoreContainerChildren$GsonTypeAdapter */
            /* loaded from: classes.dex */
            public static final class GsonTypeAdapter extends TypeAdapter<ScoreContainer.ScoreContainerChildren> {
                ...
                public void write(JsonWriter jsonWriter, ScoreContainer.ScoreContainerChildren scoreContainerChildren) {
                ...
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // com.google.gson.TypeAdapter
                public ScoreContainer.ScoreContainerChildren read(JsonReader jsonReader) {
                    char c;
                    ...
                    return new AutoValue_ScoreContainer_ScoreContainerChildren(str4, str5, str6, map3, map4, imageElement2, simpleElement2, simpleElement3, simpleElement4);
                }
            }
        };
    }
