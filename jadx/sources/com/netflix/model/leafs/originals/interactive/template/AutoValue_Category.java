...
public final class AutoValue_Category extends C$AutoValue_Category {
    public static final Parcelable.Creator<AutoValue_Category> CREATOR = new Parcelable.Creator<AutoValue_Category>() { // from class: com.netflix.model.leafs.originals.interactive.template.AutoValue_Category.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public AutoValue_Category createFromParcel(Parcel parcel) {
            return new AutoValue_Category(parcel.readInt() == 0 ? parcel.readString() : null, parcel.readInt() == 0 ? parcel.readString() : null, parcel.readInt() == 0 ? parcel.readString() : null, parcel.readHashMap(Category.class.getClassLoader()), parcel.readHashMap(Category.class.getClassLoader()), (Category.CategoryChildren) parcel.readParcelable(Category.class.getClassLoader()));
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AutoValue_Category(final String str, final String str2, final String str3, final Map<String, AnimationTemplateId> map, final Map<String, VisualStateDefinition> map2, final Category.CategoryChildren categoryChildren) {
        new C$$AutoValue_Category(str, str2, str3, map, map2, categoryChildren) { // from class: com.netflix.model.leafs.originals.interactive.template.$AutoValue_Category

            /* renamed from: com.netflix.model.leafs.originals.interactive.template.$AutoValue_Category$GsonTypeAdapter */
            /* loaded from: classes.dex */
            public static final class GsonTypeAdapter extends TypeAdapter<Category> {
                private final TypeAdapter<Category.CategoryChildren> childrenAdapter;
                ...
                private Category.CategoryChildren defaultChildren = null;

                public GsonTypeAdapter setDefaultChildren(Category.CategoryChildren categoryChildren) {
                    this.defaultChildren = categoryChildren;
                    return this;
                }
                ...
                public GsonTypeAdapter(Gson gson) {
                    ...
                    this.childrenAdapter = gson.getAdapter(Category.CategoryChildren.class);
                }
                ...
                public void write(JsonWriter jsonWriter, Category category) {
                    ...
                    this.idAdapter.write(jsonWriter, category.id());
                    jsonWriter.name("type");
                    this.typeAdapter.write(jsonWriter, category.type());
                    jsonWriter.name("styleId");
                    this.styleIdAdapter.write(jsonWriter, category.styleId());
                    jsonWriter.name("visualStateTransitions");
                    this.visualStateTransitionsAdapter.write(jsonWriter, category.visualStateTransitions());
                    jsonWriter.name("visualStates");
                    this.visualStatesAdapter.write(jsonWriter, category.visualStates());
                    jsonWriter.name("children");
                    this.childrenAdapter.write(jsonWriter, category.children());
                ...
                public Category read(JsonReader jsonReader) {
                    ...
                    Category.CategoryChildren categoryChildren = this.defaultChildren;
                    while (jsonReader.hasNext()) {
                        ...
                        if (jsonReader.peek() == JsonToken.NULL) {
                            ...
                            if (c == 0) {
                                ...
                                categoryChildren = this.childrenAdapter.read(jsonReader);
                            } else {
                    ...
                    return new AutoValue_Category(str4, str5, str6, map, map2, categoryChildren);
                }
            }
        };
    }
