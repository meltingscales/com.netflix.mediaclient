...
public final class AutoValue_NotificationCtaButton extends C$AutoValue_NotificationCtaButton {
    public static final Parcelable.Creator<AutoValue_NotificationCtaButton> CREATOR = new Parcelable.Creator<AutoValue_NotificationCtaButton>() { // from class: com.netflix.model.leafs.social.multititle.AutoValue_NotificationCtaButton.1
        ...
        public AutoValue_NotificationCtaButton createFromParcel(Parcel parcel) {
            return new AutoValue_NotificationCtaButton(parcel.readString(), parcel.readString(), (UserNotificationCtaButtonTrackingInfo) parcel.readParcelable(NotificationCtaButton.class.getClassLoader()));
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AutoValue_NotificationCtaButton(String str, String str2, UserNotificationCtaButtonTrackingInfo userNotificationCtaButtonTrackingInfo) {
        new C$$AutoValue_NotificationCtaButton(str, str2, userNotificationCtaButtonTrackingInfo) { // from class: com.netflix.model.leafs.social.multititle.$AutoValue_NotificationCtaButton
            ...
            public static final class GsonTypeAdapter extends TypeAdapter<NotificationCtaButton> {
                ...
                */
                public com.netflix.model.leafs.social.multititle.NotificationCtaButton read(com.google.gson.stream.JsonReader r9) {
                    /*
                        r8 = this;
                    ...
                    Ld:
                        ...
                        com.netflix.model.leafs.social.UserNotificationCtaButtonTrackingInfo r2 = r8.defaultTrackingInfo
                    L16:
                    ...
                    L79:
                        ...
                        goto L16
                    L82:
                        com.google.gson.TypeAdapter<com.netflix.model.leafs.social.UserNotificationCtaButtonTrackingInfo> r2 = r8.trackingInfoAdapter
                        java.lang.Object r2 = r2.read(r9)
                        com.netflix.model.leafs.social.UserNotificationCtaButtonTrackingInfo r2 = (com.netflix.model.leafs.social.UserNotificationCtaButtonTrackingInfo) r2
                        goto L16
                    L8b:
                        r9.endObject()
                        com.netflix.model.leafs.social.multititle.AutoValue_NotificationCtaButton r9 = new com.netflix.model.leafs.social.multititle.AutoValue_NotificationCtaButton
                        r9.<init>(r0, r1, r2)
                        return r9
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.netflix.model.leafs.social.multititle.C$AutoValue_NotificationCtaButton.GsonTypeAdapter.read(com.google.gson.stream.JsonReader):com.netflix.model.leafs.social.multititle.NotificationCtaButton");
                }
            }
        };
    }
