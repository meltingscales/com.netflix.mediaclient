...
public abstract class Hilt_FaqFragment extends NetflixDialogFrag {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((FaqFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectFaqFragment((FaqFragment) UnsafeCasts.unsafeCast(this));
    }
}
