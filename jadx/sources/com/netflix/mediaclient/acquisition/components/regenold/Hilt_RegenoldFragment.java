...
public abstract class Hilt_RegenoldFragment extends NetflixDialogFrag {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((RegenoldFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectRegenoldFragment((RegenoldFragment) UnsafeCasts.unsafeCast(this));
    }
}
