...
public final class RegenoldViewModelInitializer_Factory implements Factory<RegenoldViewModelInitializer> {
    ...
    public RegenoldViewModelInitializer get() {
    ...
    public static RegenoldViewModelInitializer_Factory create(Provider<FlowMode> provider, Provider<SignupErrorReporter> provider2, Provider<SignupNetworkManager> provider3, Provider<StringProvider> provider4, Provider<ViewModelProvider.Factory> provider5, Provider<ErrorMessageViewModelInitializer> provider6, Provider<FormViewEditTextViewModelInitializer> provider7) {
        return new RegenoldViewModelInitializer_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static RegenoldViewModelInitializer newInstance(FlowMode flowMode, SignupErrorReporter signupErrorReporter, SignupNetworkManager signupNetworkManager, StringProvider stringProvider, ViewModelProvider.Factory factory, ErrorMessageViewModelInitializer errorMessageViewModelInitializer, FormViewEditTextViewModelInitializer formViewEditTextViewModelInitializer) {
        return new RegenoldViewModelInitializer(flowMode, signupErrorReporter, signupNetworkManager, stringProvider, factory, errorMessageViewModelInitializer, formViewEditTextViewModelInitializer);
    }
}
