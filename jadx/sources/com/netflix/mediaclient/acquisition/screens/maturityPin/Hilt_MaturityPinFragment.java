...
public abstract class Hilt_MaturityPinFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((MaturityPinFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectMaturityPinFragment((MaturityPinFragment) UnsafeCasts.unsafeCast(this));
    }
}
