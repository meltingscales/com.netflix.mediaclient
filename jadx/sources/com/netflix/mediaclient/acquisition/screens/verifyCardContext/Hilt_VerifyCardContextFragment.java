...
public abstract class Hilt_VerifyCardContextFragment extends AbstractSignupFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((VerifyCardContextFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectVerifyCardContextFragment((VerifyCardContextFragment) UnsafeCasts.unsafeCast(this));
    }
}
