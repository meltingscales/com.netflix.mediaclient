...
public abstract class Hilt_SecondaryLanguageFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((SecondaryLanguageFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectSecondaryLanguageFragment((SecondaryLanguageFragment) UnsafeCasts.unsafeCast(this));
    }
}
