...
public abstract class Hilt_OnRampFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((OnRampFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectOnRampFragment((OnRampFragment) UnsafeCasts.unsafeCast(this));
    }
}
