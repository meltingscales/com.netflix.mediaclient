...
public abstract class Hilt_AddProfilesFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((AddProfilesFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectAddProfilesFragment((AddProfilesFragment) UnsafeCasts.unsafeCast(this));
    }
}
