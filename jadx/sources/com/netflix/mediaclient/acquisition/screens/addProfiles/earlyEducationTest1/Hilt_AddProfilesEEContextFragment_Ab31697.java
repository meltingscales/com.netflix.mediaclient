...
public abstract class Hilt_AddProfilesEEContextFragment_Ab31697 extends AbstractSignupFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((AddProfilesEEContextFragment_Ab31697_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectAddProfilesEEContextFragment_Ab31697((AddProfilesEEContextFragment_Ab31697) UnsafeCasts.unsafeCast(this));
    }
}
