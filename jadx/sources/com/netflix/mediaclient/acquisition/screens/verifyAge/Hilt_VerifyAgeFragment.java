...
public abstract class Hilt_VerifyAgeFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((VerifyAgeFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectVerifyAgeFragment((VerifyAgeFragment) UnsafeCasts.unsafeCast(this));
    }
}
