...
public abstract class Hilt_UpiWaitingFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((UpiWaitingFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectUpiWaitingFragment((UpiWaitingFragment) UnsafeCasts.unsafeCast(this));
    }
}
