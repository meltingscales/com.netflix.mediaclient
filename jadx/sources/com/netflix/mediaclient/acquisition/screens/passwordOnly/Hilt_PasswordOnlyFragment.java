...
public abstract class Hilt_PasswordOnlyFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((PasswordOnlyFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectPasswordOnlyFragment((PasswordOnlyFragment) UnsafeCasts.unsafeCast(this));
    }
}
