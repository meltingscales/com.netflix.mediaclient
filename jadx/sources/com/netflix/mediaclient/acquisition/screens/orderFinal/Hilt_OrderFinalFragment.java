...
public abstract class Hilt_OrderFinalFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((OrderFinalFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectOrderFinalFragment((OrderFinalFragment) UnsafeCasts.unsafeCast(this));
    }
}
