...
public abstract class Hilt_WelcomeFujiFragmentAb44926 extends WelcomeFujiFragment {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((WelcomeFujiFragmentAb44926_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectWelcomeFujiFragmentAb44926((WelcomeFujiFragmentAb44926) UnsafeCasts.unsafeCast(this));
    }
}
