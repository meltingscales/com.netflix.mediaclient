...
public abstract class Hilt_WelcomeFujiFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((WelcomeFujiFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectWelcomeFujiFragment((WelcomeFujiFragment) UnsafeCasts.unsafeCast(this));
    }
}
