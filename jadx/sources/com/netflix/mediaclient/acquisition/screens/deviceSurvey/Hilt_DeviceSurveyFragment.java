...
public abstract class Hilt_DeviceSurveyFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((DeviceSurveyFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectDeviceSurveyFragment((DeviceSurveyFragment) UnsafeCasts.unsafeCast(this));
    }
}
