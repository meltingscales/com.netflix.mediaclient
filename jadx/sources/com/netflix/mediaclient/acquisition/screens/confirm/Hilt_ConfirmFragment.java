...
public abstract class Hilt_ConfirmFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((ConfirmFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectConfirmFragment((ConfirmFragment) UnsafeCasts.unsafeCast(this));
    }
}
