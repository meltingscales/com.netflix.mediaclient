...
public abstract class Hilt_LearnMoreConfirmFragment extends AbstractNetworkFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((LearnMoreConfirmFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectLearnMoreConfirmFragment((LearnMoreConfirmFragment) UnsafeCasts.unsafeCast(this));
    }
}
