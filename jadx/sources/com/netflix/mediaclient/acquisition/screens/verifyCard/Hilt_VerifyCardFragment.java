...
public abstract class Hilt_VerifyCardFragment extends AbstractSignupFragment2 {
    ...
    public void inject() {
        ...
        this.injected = true;
        ((VerifyCardFragment_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectVerifyCardFragment((VerifyCardFragment) UnsafeCasts.unsafeCast(this));
    }
}
