...
public final class ReggieRegistrationTrayBinding {
    ...
    private ReggieRegistrationTrayBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, FrameLayout frameLayout) {
    ...
    public static ReggieRegistrationTrayBinding bind(View view) {
        ...
        if (frameLayout != null) {
            return new ReggieRegistrationTrayBinding(constraintLayout, constraintLayout, frameLayout);
        }
