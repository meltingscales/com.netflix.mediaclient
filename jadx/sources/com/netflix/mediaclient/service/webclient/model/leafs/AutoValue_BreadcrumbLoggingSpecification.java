...
public final class AutoValue_BreadcrumbLoggingSpecification extends C$AutoValue_BreadcrumbLoggingSpecification {
    AutoValue_BreadcrumbLoggingSpecification(final String str, final boolean z, final int i) {
        new BreadcrumbLoggingSpecification(str, z, i) { // from class: com.netflix.mediaclient.service.webclient.model.leafs.$AutoValue_BreadcrumbLoggingSpecification
            ...
            public String toString() {
                return "BreadcrumbLoggingSpecification{implementation=" + this.implementation + ", disabled=" + this.disabled + ", disableChancePercentage=" + this.disableChancePercentage + "}";
            }
    ...
    /* loaded from: classes.dex */
    public static final class GsonTypeAdapter extends TypeAdapter<BreadcrumbLoggingSpecification> {
        ...
        public void write(JsonWriter jsonWriter, BreadcrumbLoggingSpecification breadcrumbLoggingSpecification) {
            ...
            this.implementationAdapter.write(jsonWriter, breadcrumbLoggingSpecification.getImplementation());
            jsonWriter.name("disable");
            this.disabledAdapter.write(jsonWriter, Boolean.valueOf(breadcrumbLoggingSpecification.isDisabled()));
            jsonWriter.name("disableChancePercentage");
            this.disableChancePercentageAdapter.write(jsonWriter, Integer.valueOf(breadcrumbLoggingSpecification.getDisableChancePercentage()));
        ...
        */
        public com.netflix.mediaclient.service.webclient.model.leafs.BreadcrumbLoggingSpecification read(com.google.gson.stream.JsonReader r9) {
            /*
                r8 = this;
            ...
            L93:
                ...
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: com.netflix.mediaclient.service.webclient.model.leafs.AutoValue_BreadcrumbLoggingSpecification.GsonTypeAdapter.read(com.google.gson.stream.JsonReader):com.netflix.mediaclient.service.webclient.model.leafs.BreadcrumbLoggingSpecification");
        }
    }
}
