...
public class LolomoTtrEvent extends Data {
    private LolomoTtrArgs args;
    ...
    public LolomoTtrEvent(LolomoTtrArgs lolomoTtrArgs, Long l, NetflixTraceCategory netflixTraceCategory, Object obj, TraceEventFormatTypeX traceEventFormatTypeX, NetflixTraceEventTypeTiming netflixTraceEventTypeTiming, Long l2) {
        this.args = lolomoTtrArgs;
        this.dur = l;
