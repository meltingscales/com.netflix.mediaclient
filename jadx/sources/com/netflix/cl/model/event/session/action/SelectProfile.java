...
public class SelectProfile extends ActionTracked {
    private CommandValue command;
    private AppView parentView;
    private String profileGuid;
    private AppView view;

    public SelectProfile(AppView appView, String str, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
        addContextType("SelectProfile");
        this.view = appView;
