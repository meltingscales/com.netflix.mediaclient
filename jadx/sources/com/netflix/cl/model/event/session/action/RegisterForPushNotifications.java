...
public class RegisterForPushNotifications extends ActionTracked implements Exclusive {
    private CommandValue command;
    private AppView parentView;
    private AppView view;

    public RegisterForPushNotifications(AppView appView, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
