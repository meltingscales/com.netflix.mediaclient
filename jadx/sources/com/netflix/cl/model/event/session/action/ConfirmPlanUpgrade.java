...
public class ConfirmPlanUpgrade extends ActionTracked {
    private CommandValue command;
    private AppView parentView;
    private PlanUpgradeType planUpgradeType;
    private AppView view;

    public ConfirmPlanUpgrade(AppView appView, AppView appView2, PlanUpgradeType planUpgradeType, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
        addContextType("ConfirmPlanUpgrade");
        this.view = appView;
        this.parentView = appView2;
        this.planUpgradeType = planUpgradeType;
    ...
    public JSONObject toJSONObject() {
        ...
        ExtCLUtils.addObjectToJson(jSONObject, "planUpgradeType", this.planUpgradeType);
