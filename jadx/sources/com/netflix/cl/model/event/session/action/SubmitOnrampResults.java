...
public class SubmitOnrampResults extends ActionTracked {
    private CommandValue command;
    private AppView parentView;
    private Object results;
    private AppView view;

    public SubmitOnrampResults(AppView appView, AppView appView2, Object obj, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
        addContextType("SubmitOnrampResults");
        this.view = appView;
    ...
    public JSONObject toJSONObject() {
        ...
        ExtCLUtils.addObjectToJson(jSONObject, "results", this.results);
