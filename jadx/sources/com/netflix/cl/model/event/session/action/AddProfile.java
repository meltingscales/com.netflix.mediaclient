...
public class AddProfile extends ActionTracked {
    private CommandValue command;
    private ProfileSettings desiredSettings;
    private AppView parentView;
    private AppView view;

    public AddProfile(AppView appView, AppView appView2, ProfileSettings profileSettings, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
