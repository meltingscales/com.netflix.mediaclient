...
public class RequestSharedCredentials extends ActionTracked {
    private CommandValue command;
    private AppView parentView;
    private AppView view;

    public RequestSharedCredentials(AppView appView, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
        addContextType("RequestSharedCredentials");
        this.view = appView;
