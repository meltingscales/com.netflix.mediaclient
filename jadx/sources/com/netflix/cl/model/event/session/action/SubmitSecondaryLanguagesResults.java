...
public class SubmitSecondaryLanguagesResults extends ActionTracked {
    private CommandValue command;
    private AppView parentView;
    private AppView view;

    public SubmitSecondaryLanguagesResults(AppView appView, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
        addContextType("SubmitSecondaryLanguagesResults");
        this.view = appView;
