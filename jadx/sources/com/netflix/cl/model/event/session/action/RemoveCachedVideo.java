...
public class RemoveCachedVideo extends ActionTracked {
    private CommandValue command;
    private Long oxid;
    private AppView parentView;
    private AppView view;

    public RemoveCachedVideo(Long l, AppView appView, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
        addContextType("RemoveCachedVideo");
        this.oxid = l;
        this.view = appView;
