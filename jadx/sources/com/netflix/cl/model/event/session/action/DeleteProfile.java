...
public class DeleteProfile extends ActionTracked {
    private CommandValue command;
    private AppView parentView;
    private String profileGuid;
    private AppView view;

    public DeleteProfile(AppView appView, String str, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(trackingInfo);
        addContextType("DeleteProfile");
        this.view = appView;
