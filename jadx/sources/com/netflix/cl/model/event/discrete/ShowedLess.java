...
public class ShowedLess extends DiscreteAction {
    private AppView parentView;
    private AppView view;

    public ShowedLess(AppView appView, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(commandValue, trackingInfo);
        addContextType("ShowedLess");
        this.view = appView;
