...
public class Skipped extends DiscreteAction {
    private AppView parentView;
    private AppView view;

    public Skipped(AppView appView, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(commandValue, trackingInfo);
        addContextType("Skipped");
        this.view = appView;
