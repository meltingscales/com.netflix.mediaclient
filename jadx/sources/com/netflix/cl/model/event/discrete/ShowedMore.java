...
public class ShowedMore extends DiscreteAction {
    private AppView parentView;
    private AppView view;

    public ShowedMore(AppView appView, AppView appView2, CommandValue commandValue, TrackingInfo trackingInfo) {
        super(commandValue, trackingInfo);
        addContextType("ShowedMore");
        this.view = appView;
