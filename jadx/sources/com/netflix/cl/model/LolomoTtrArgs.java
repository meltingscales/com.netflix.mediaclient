...
public class LolomoTtrArgs extends Data {
    ...
    public LolomoTtrArgs(NetlixAppState netlixAppState, String str, Boolean bool, AppView appView, NetflixTraceStatus netflixTraceStatus, Boolean bool2, JSONObject jSONObject) {
        this.appState = netlixAppState;
        this.statusMsg = str;
        this.cached = bool;
        this.navigationLevel = appView;
        this.status = netflixTraceStatus;
        this.switchedProfile = bool2;
