...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(InteractiveAnimation.ANIMATION_TYPE.OPACITY)) {
            arrayList.add(motionSpec.getAnimator(InteractiveAnimation.ANIMATION_TYPE.OPACITY, this.fab, View.ALPHA));
        }
        if (motionSpec.hasPropertyValues(InteractiveAnimation.ANIMATION_TYPE.SCALE)) {
            arrayList.add(motionSpec.getAnimator(InteractiveAnimation.ANIMATION_TYPE.SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(InteractiveAnimation.ANIMATION_TYPE.SCALE, this.fab, View.SCALE_X));
        }
        if (motionSpec.hasPropertyValues(InteractiveAnimation.ANIMATION_TYPE.WIDTH)) {
            arrayList.add(motionSpec.getAnimator(InteractiveAnimation.ANIMATION_TYPE.WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(InteractiveAnimation.ANIMATION_TYPE.HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(InteractiveAnimation.ANIMATION_TYPE.HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
