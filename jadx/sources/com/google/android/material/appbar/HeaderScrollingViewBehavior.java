...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public void layoutChild(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (findFirstDependency != null) {
            ...
            rect.set(paddingLeft + i2, bottom + i3, (width - paddingRight) - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, ((coordinatorLayout.getHeight() + findFirstDependency.getBottom()) - coordinatorLayout.getPaddingBottom()) - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
