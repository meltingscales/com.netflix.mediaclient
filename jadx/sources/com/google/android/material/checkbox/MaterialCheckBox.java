...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static byte e$ss2$4526;
    ...
    */
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (m = AndroidAutofill$$ExternalSyntheticApiModelOutline2.m(getContext().getSystemService(AndroidAutofill$$ExternalSyntheticApiModelOutline1.m()))) != null) {
    ...
    private void c(String str, Object[] objArr) {
        ...
        for (int i = 0; i < decode.length; i++) {
            bArr[i] = (byte) (decode[(decode.length - i) - 1] ^ e$ss2$4526);
        }
