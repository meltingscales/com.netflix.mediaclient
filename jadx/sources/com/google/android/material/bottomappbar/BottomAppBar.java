...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    */
    ...
    private void createMenuViewTranslationAnimation(final int i, final boolean z, List<Animator> list) {
        ...
        Animator ofFloat = ObjectAnimator.ofFloat(actionMenuView, InteractiveAnimation.ANIMATION_TYPE.ALPHA, 1.0f);
        ofFloat.setDuration(0.8f * fabAlignmentAnimationDuration);
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i, z)) > 1.0f) {
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(actionMenuView, InteractiveAnimation.ANIMATION_TYPE.ALPHA, 0.0f);
    ...
    public float getFabTranslationX(int i) {
        ...
        if (i == 1) {
            ...
            int measuredWidth = (this.fabAlignmentModeEndMargin == -1 || findDependentView == null) ? this.fabOffsetEndMode : (findDependentView.getMeasuredWidth() / 2) + this.fabAlignmentModeEndMargin;
            return ((getMeasuredWidth() / 2) - (i2 + measuredWidth)) * (isLayoutRtl ? -1 : 1);
        }
        return 0.0f;
    }
