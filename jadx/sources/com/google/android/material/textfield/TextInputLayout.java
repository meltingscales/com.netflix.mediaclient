...
public class TextInputLayout extends LinearLayout {
    ...
    private static byte e$ss2$20976;
    ...
    */
        ...
        if (i != 0) {
            ...
            if (string.startsWith("'!#+")) {
                ...
                if (text instanceof Spanned) {
                    SpannableString spannableString2 = new SpannableString(intern);
                    TextUtils.copySpansFrom((SpannedString) text, 0, intern.length(), Object.class, spannableString2, 0);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x003a, code lost:
        if ((!r5.startsWith("'!#+")) != true) goto L10;
     */
    /* JADX WARN: Code restructure failed: missing block: B:11:0x003c, code lost:
        r3 = com.google.android.material.textfield.TextInputLayout.e + 17;
        com.google.android.material.textfield.TextInputLayout.b = r3 % 128;
        r3 = r3 % 2;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x005d, code lost:
        if ((r13 instanceof android.text.Spanned) == false) goto L7;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setStartIconContentDescription(int r13) {
        /*
            r12 = this;
            r0 = 2
            int r1 = r0 % r0
            int r1 = com.google.android.material.textfield.TextInputLayout.b
            int r1 = r1 + 119
            int r2 = r1 % 128
            com.google.android.material.textfield.TextInputLayout.e = r2
            int r1 = r1 % r0
            if (r13 == 0) goto L78
            int r2 = r2 + 17
            int r1 = r2 % 128
            com.google.android.material.textfield.TextInputLayout.b = r1
            int r2 = r2 % r0
            r1 = 0
            java.lang.String r3 = "'!#+"
            r4 = 1
        ...
        L2d:
            ...
            if (r3 == r4) goto L79
        L3c:
            int r3 = com.google.android.material.textfield.TextInputLayout.e
            int r3 = r3 + 17
            int r6 = r3 % 128
            com.google.android.material.textfield.TextInputLayout.b = r6
            int r3 = r3 % r0
            r0 = 4
        ...
        L78:
            r5 = 0
        L79:
            r12.setStartIconContentDescription(r5)
            return
        */
    ...
    public void updateTextInputBoxState() {
        ...
        if (!isEnabled()) {
            ...
            if (!this.counterOverflowed || (textView = this.counterView) == null) {
                i = z2 ? this.focusedStrokeColor : z3 ? this.hoveredStrokeColor : this.defaultStrokeColor;
        ...
        if (this.boxBackgroundMode == 2) {
            ...
            this.boxStrokeWidthPx = (z2 && isEnabled()) ? this.boxStrokeWidthFocusedPx : this.boxStrokeWidthDefaultPx;
    ...
    private void c(String str, Object[] objArr) {
        ...
        for (int i = 0; i < decode.length; i++) {
            bArr[i] = (byte) (decode[(decode.length - i) - 1] ^ e$ss2$20976);
        }
