    ...
    static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        private EdgeToEdgeCallback(View view, WindowInsetsCompat windowInsetsCompat) {
            ...
            if (backgroundTintList != null) {
                ...
                this.lightBottomSheet = view.getBackground() instanceof ColorDrawable ? Boolean.valueOf(MaterialColors.isColorLight(((ColorDrawable) view.getBackground()).getColor())) : null;
            }
        }
