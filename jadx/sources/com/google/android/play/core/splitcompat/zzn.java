...
public final class zzn {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ Set zza(zzn zznVar, Set set, zzt zztVar, ZipFile zipFile) {
        HashSet hashSet = new HashSet();
        zznVar.zzf(zztVar, set, new zzj(zznVar, hashSet, zztVar, zipFile));
        return hashSet;
    }

    private static void zze(zzt zztVar, zzk zzkVar) {
        ZipFile zipFile;
        String[] strArr;
        try {
    ...
    public final void zzf(zzt zztVar, Set set, zzl zzlVar) {
        Iterator it = set.iterator();
        while (it.hasNext()) {
            zzm zzmVar = (zzm) it.next();
            File zzc = this.zzb.zzc(zztVar.zzb(), zzmVar.zza);
            zzlVar.zza(zzmVar, zzc, zzc.exists() && zzc.length() == zzmVar.zzb.getSize() && zze.zzp(zzc));
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final Set zzb(zzt zztVar) {
