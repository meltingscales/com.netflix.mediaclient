...
final class zzdb implements zzhe {
    private final zzcy zza;

    public static zzdb zza(zzcy zzcyVar) {
        zzdb zzdbVar = zzcyVar.zza;
        return zzdbVar != null ? zzdbVar : new zzdb(zzcyVar);
    }

    private zzdb(zzcy zzcyVar) {
        zzcy zzcyVar2 = (zzcy) zzdv.zza(zzcyVar, "output");
        this.zza = zzcyVar2;
        zzcyVar2.zza = this;
    }

    @Override // com.google.android.gms.internal.recaptcha.zzhe
    ...
    @Override // com.google.android.gms.internal.recaptcha.zzhe
    public final void zza(int i, Object obj, zzfp zzfpVar) {
        this.zza.zza(i, (zzey) obj, zzfpVar);
    }

    @Override // com.google.android.gms.internal.recaptcha.zzhe
    public final void zzb(int i, Object obj, zzfp zzfpVar) {
        zzcy zzcyVar = this.zza;
        zzcyVar.zza(i, 3);
        zzfpVar.zza((zzfp) ((zzey) obj), (zzhe) zzcyVar.zza);
        zzcyVar.zza(i, 4);
    }
    ...
    public final void zza(int i, Object obj) {
        if (obj instanceof zzch) {
            this.zza.zzb(i, (zzch) obj);
        } else {
            this.zza.zza(i, (zzey) obj);
        }
    }
    ...
    public final void zza(int i, List<Integer> list, boolean z) {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzcy.zzf(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<Integer> list, boolean z) {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzcy.zzi(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzcy.zzd(list.get(i4).longValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzcy.zzk(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zza(list.get(i2).intValue());
    ...
    public final void zzi(int i, List<Boolean> list, boolean z) {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzcy.zzb(list.get(i4).booleanValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zza(int i, List<String> list) {
        ...
        if (list instanceof zzej) {
            ...
            while (i2 < list.size()) {
                Object zzb = zzejVar.zzb(i2);
                if (zzb instanceof String) {
                    this.zza.zza(i, (String) zzb);
                } else {
                    this.zza.zza(i, (zzch) zzb);
                }
                i2++;
            }
            return;
    ...
    @Override // com.google.android.gms.internal.recaptcha.zzhe
    public final void zzb(int i, List<zzch> list) {
    ...
    public final void zzj(int i, List<Integer> list, boolean z) {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzcy.zzg(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    public final void zzk(int i, List<Integer> list, boolean z) {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzcy.zzj(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
                this.zza.zzd(list.get(i2).intValue());
    ...
    public final void zzm(int i, List<Integer> list, boolean z) {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzcy.zzh(list.get(i4).intValue());
            }
            this.zza.zzb(i3);
            while (i2 < list.size()) {
    ...
    @Override // com.google.android.gms.internal.recaptcha.zzhe
    public final void zza(int i, List<?> list, zzfp zzfpVar) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zza(i, list.get(i2), zzfpVar);
        }
    }

    @Override // com.google.android.gms.internal.recaptcha.zzhe
    public final void zzb(int i, List<?> list, zzfp zzfpVar) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zzb(i, list.get(i2), zzfpVar);
        }
    }

    @Override // com.google.android.gms.internal.recaptcha.zzhe
    public final <K, V> void zza(int i, zzet<K, V> zzetVar, Map<K, V> map) {
        for (Map.Entry<K, V> entry : map.entrySet()) {
            this.zza.zza(i, 2);
            this.zza.zzb(zzeq.zza(zzetVar, entry.getKey(), entry.getValue()));
            zzeq.zza(this.zza, zzetVar, entry.getKey(), entry.getValue());
        }
    }
}
