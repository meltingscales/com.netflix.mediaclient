...
public final class zzh {
    ...
    private zzi zzg;
    private final Handler zze = new zzcv(Looper.getMainLooper());
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void zzk(zzh zzhVar, SharedPreferences sharedPreferences, String str) {
        if (zzhVar.zzv(str)) {
    ...
    public final void zzr(CastSession castSession) {
        ...
        Preconditions.checkNotNull(this.zzg);
        this.zzg.zzi = castSession != null ? castSession.zzn() : 0;
        Preconditions.checkNotNull(this.zzg);
    }
    ...
    @EnsuresNonNullIf(expression = {"analyticsSession"}, result = RippleUtils.USE_FRAMEWORK_RIPPLE)
