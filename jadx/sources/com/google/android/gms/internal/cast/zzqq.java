...
final class zzqq extends zzom implements RandomAccess, zzqa, zzri {
    private static final zzqq zza;
    private long[] zzb;
    private int zzc;

    static {
        zzqq zzqqVar = new zzqq(new long[0], 0);
        zza = zzqqVar;
        zzqqVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        zza();
        zzqc.zze(collection);
        if (!(collection instanceof zzqq)) {
            return super.addAll(collection);
        }
        zzqq zzqqVar = (zzqq) collection;
        int i = zzqqVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzqqVar.zzb, 0, this.zzb, this.zzc, zzqqVar.zzc);
        this.zzc = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzqqVar.zzc) {
            return false;
        }
        long[] jArr = zzqqVar.zzb;
    ...
    public final /* synthetic */ zzqb zzg(int i) {
        ...
        return new zzqq(Arrays.copyOf(this.zzb, i), this.zzc);
    }

    private zzqq(long[] jArr, int i) {
        this.zzb = jArr;
        this.zzc = i;
    }
