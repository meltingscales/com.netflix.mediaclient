...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public JSONObject toJson() {
        ...
        try {
            jSONObject.put(SignupConstants.Field.URL, this.zab.toString());
            jSONObject.put(InteractiveAnimation.ANIMATION_TYPE.WIDTH, this.zac);
            jSONObject.put(InteractiveAnimation.ANIMATION_TYPE.HEIGHT, this.zad);
