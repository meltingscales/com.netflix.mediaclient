...
public final class Utf8 {
            ...
            while (estimateConsecutiveAscii < i2) {
                ...
                if (b < 0) {
                    if (b < -32) {
                        ...
                        if (b2 <= -65 && (((b << 28) + (b2 + 112)) >> 30) == 0 && byteBuffer.get(estimateConsecutiveAscii + 2) <= -65) {
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0056, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r12, r0) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009b, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r12, r0) > (-65)) goto L56;
         */
        @Override // com.google.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:14:0x002d, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L16;
         */
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0061, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L35;
         */
        /* JADX WARN: Code restructure failed: missing block: B:56:0x00a3, code lost:
            if (com.google.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L55;
         */
        @Override // com.google.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        String decodeUtf8Direct(ByteBuffer byteBuffer, int i, int i2) {
            ...
            while (addressOffset < j) {
                ...
                if (DecodeUtil.isOneByte(b2)) {
                    ...
                    DecodeUtil.handleThreeBytes(b2, UnsafeUtil.getByte(j2), UnsafeUtil.getByte(addressOffset + 2), cArr, i4);
                    i4++;
                    addressOffset = 3 + addressOffset;
                } else if (j2 >= j - 2) {
                    throw InvalidProtocolBufferException.invalidUtf8();
                } else {
                    DecodeUtil.handleFourBytes(b2, UnsafeUtil.getByte(j2), UnsafeUtil.getByte(2 + addressOffset), UnsafeUtil.getByte(addressOffset + 3), cArr, i4);
                    i4 += 2;
                    addressOffset += 4;
                }
            }
