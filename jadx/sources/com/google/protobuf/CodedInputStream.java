                    ...
                    if (i2 >= 0) {
                        ...
                        if (i3 >= 0) {
                            ...
                            if (i4 < 0) {
                                ...
                                long j8 = 5 + j5;
                                long j9 = i4 ^ (UnsafeUtil.getByte(j7) << 28);
                                if (j9 >= 0) {
                                    j4 = 266354560;
                                } else {
                                    long j10 = 6 + j5;
        ...
        public long readRawVarint64() {
            ...
            if (this.currentByteBufferLimit != j4) {
                ...
                if (b >= 0) {
                    ...
                    long j5 = 2 + j4;
                    int i2 = b ^ (UnsafeUtil.getByte(1 + j4) << 7);
                    if (i2 >= 0) {
                        long j6 = 3 + j4;
                                    ...
                                    if (j10 < 0) {
                                        ...
                                        if (j8 >= 0) {
                                            ...
                                            if (j10 < 0) {
                                                ...
                                                j7 = 9 + j4;
                                                long j11 = (j10 ^ (UnsafeUtil.getByte(j9) << 56)) ^ 71499008037633920L;
                                                if (j11 >= 0) {
                                                    j = j11;
                                                    j5 = j7;
                                                } else if (UnsafeUtil.getByte(j7) >= 0) {
                                                    j5 = j4 + 10;
                                                    j = j11;
                                                }
                                            }
