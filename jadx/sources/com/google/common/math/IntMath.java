...
public final class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, Prefetch.NANOSECONDS_PER_MILLISECOND, 10000000, 100000000, Prefetch.NANOSECONDS_PER_SECOND};
    ...
    static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, AleCryptoBouncyCastle.MAX_RANDOM_BYTES, 2345, 477, 193, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive(InteractiveAnimation.ANIMATION_TYPE.X, i);
