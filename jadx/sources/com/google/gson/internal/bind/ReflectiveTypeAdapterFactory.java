            ...
            while (i3 < length) {
                ...
                if (includeField || includeField2) {
                    ...
                    while (i4 < size) {
                        ...
                        boolean z9 = i4 != 0 ? false : includeField;
                        int i5 = i4;
                        ...
                        int i8 = length;
                        boolean z10 = z8;
                        boundField2 = boundField3 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, method, str, TypeToken.get(resolve), z9, z4, z3)) : boundField3;
                        includeField = z9;
                        i3 = i7;
                        size = i6;
                        fieldNames = list;
