        ...
        TypeAdapter<Calendar> typeAdapter13 = new TypeAdapter<Calendar>() { // from class: com.google.gson.internal.bind.TypeAdapters.26
            ...
            public Calendar read(JsonReader jsonReader) {
                ...
                while (jsonReader.peek() != JsonToken.END_OBJECT) {
                    ...
                    int nextInt = jsonReader.nextInt();
                    if (SignupConstants.Field.DEMO_COLLECT_BIRTH_YEAR.equals(nextName)) {
                        i = nextInt;
                    } else if (SignupConstants.Field.DEMO_COLLECT_BIRTH_MONTH.equals(nextName)) {
                        i2 = nextInt;
            ...
            public void write(JsonWriter jsonWriter, Calendar calendar) {
                ...
                jsonWriter.name(SignupConstants.Field.DEMO_COLLECT_BIRTH_YEAR);
                jsonWriter.value(calendar.get(1));
                jsonWriter.name(SignupConstants.Field.DEMO_COLLECT_BIRTH_MONTH);
