...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent3 {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:44:0x0126, code lost:
        if (r0.onMeasureChild(r31, r19, r25, r20, r26, 0) == false) goto L33;
     */
    ...
    */
    ...
    private void constrainChildRect(LayoutParams layoutParams, Rect rect, int i, int i2) {
        ...
        int max = Math.max(i4, Math.min(rect.left, ((width - getPaddingRight()) - i) - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin));
        int paddingTop = getPaddingTop();
        int i5 = ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
        int i6 = paddingTop + i5;
        int max2 = Math.max(i6, Math.min(rect.top, ((height - getPaddingBottom()) - i2) - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin));
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (behavior != null) {
            ...
            if (scrimOpacity > 0.0f) {
                ...
                this.mScrimPaint.setAlpha(clamp(Math.round(scrimOpacity * 255.0f), 0, PrivateKeyType.INVALID));
