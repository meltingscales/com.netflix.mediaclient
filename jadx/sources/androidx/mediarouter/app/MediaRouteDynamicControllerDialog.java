...
public class MediaRouteDynamicControllerDialog extends AppCompatDialog {
    ...
    private static byte e$ss2$2342;
    ...
    */
    ...
    public void onCreate(Bundle bundle) {
        ...
        String string = this.mContext.getResources().getString(R.string.mr_cast_dialog_title_view_placeholder);
    ...
    private void c(String str, Object[] objArr) {
        ...
        for (int i = 0; i < decode.length; i++) {
            bArr[i] = (byte) (decode[(decode.length - i) - 1] ^ e$ss2$2342);
        }
