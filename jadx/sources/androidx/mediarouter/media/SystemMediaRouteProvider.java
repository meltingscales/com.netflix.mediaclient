...
public abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    public static class JellybeanImpl extends SystemMediaRouteProvider implements MediaRouterJellybean.Callback, MediaRouterJellybean.VolumeCallback {
        ...
        private static byte e$ss2$3615;
        ...
        public JellybeanImpl(Context context, SyncCallback syncCallback) {
            ...
            String string = context.getResources().getString(R.string.mr_user_route_category_name);
            ...
            this.mUserRouteCategoryObj = MediaRouterJellybean.createRouteCategory(mediaRouter, string, false);
            updateSystemRoutes();
            int i4 = a + 31;
            e = i4 % 128;
            if (i4 % 2 == 0) {
        ...
        private static void b(String str, Object[] objArr) {
            ...
            for (int i = 0; i < decode.length; i++) {
                bArr[i] = (byte) (decode[(decode.length - i) - 1] ^ e$ss2$3615);
            }
