    ...
    public void getValuesToInterpolate(float[] fArr) {
        switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[this.mType.ordinal()]) {
            ...
            case 2:
                ...
                fArr[0] = (float) Math.pow(((i >> 16) & PrivateKeyType.INVALID) / 255.0f, 2.2d);
                fArr[1] = (float) Math.pow(((i >> 8) & PrivateKeyType.INVALID) / 255.0f, 2.2d);
                fArr[2] = (float) Math.pow((i & PrivateKeyType.INVALID) / 255.0f, 2.2d);
                fArr[3] = ((i >> 24) & PrivateKeyType.INVALID) / 255.0f;
                return;
            case 3:
