...
public class ConstraintLayoutStates {
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            if (SignupConstants.Field.LANG_ID.equals(xmlPullParser.getAttributeName(i))) {
                String attributeValue = xmlPullParser.getAttributeValue(i);
                int identifier = attributeValue.contains("/") ? context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), SignupConstants.Field.LANG_ID, context.getPackageName()) : -1;
                if (identifier == -1) {
