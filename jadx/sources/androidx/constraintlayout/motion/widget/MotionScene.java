...
public class MotionScene {
    ...
    */
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int i, Transition transition) {
                ...
                if (motionLayout2 != null) {
                    ...
                    boolean z3 = (i5 & JSONzip.end) != 0 && i == i3;
            ...
            /* JADX WARN: Code restructure failed: missing block: B:35:0x0093, code lost:
                if (r8.getProgress() <= 0.5f) goto L32;
             */
    ...
    private int getId(Context context, String str) {
        int i;
        if (str.contains("/")) {
            i = context.getResources().getIdentifier(str.substring(str.indexOf(47) + 1), SignupConstants.Field.LANG_ID, context.getPackageName());
            if (this.DEBUG_DESKTOP) {
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i3 = 0; i3 < attributeCount; i3++) {
            ...
            } else if (attributeName.equals(SignupConstants.Field.LANG_ID)) {
