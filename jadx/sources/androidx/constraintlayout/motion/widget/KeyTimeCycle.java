...
public class KeyTimeCycle extends Key {
    ...
    public void setInterpolation(HashMap<String, Integer> hashMap) {
        ...
        if (!Float.isNaN(this.mAlpha)) {
            hashMap.put(InteractiveAnimation.ANIMATION_TYPE.ALPHA, Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mElevation)) {
            hashMap.put("elevation", Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mRotation)) {
            hashMap.put(InteractiveAnimation.ANIMATION_TYPE.ROTATION, Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mRotationX)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0089, code lost:
        if (r1.equals("scaleY") == false) goto L133;
     */
    /*
