...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        paint.setShader(new RadialGradient(0.0f, 0.0f, f4 + f5, new int[]{i, i, this.mShadowEndColor}, new float[]{0.0f, f4 / (f5 + f4), 1.0f}, tileMode));
        Paint paint2 = this.mEdgeShadowPaint;
        float f6 = -this.mCornerRadius;
        float f7 = this.mShadowSize;
        int i2 = this.mShadowStartColor;
        paint2.setShader(new LinearGradient(0.0f, f6 + f7, 0.0f, f6 - f7, new int[]{i2, i2, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, tileMode));
