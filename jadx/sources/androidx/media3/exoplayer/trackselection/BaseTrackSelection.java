...
public abstract class BaseTrackSelection implements ExoTrackSelection {
    ...
    public BaseTrackSelection(TrackGroup trackGroup, int... iArr) {
        this(null, trackGroup, iArr, 0);
    }

    public BaseTrackSelection(Comparator<Format> comparator, TrackGroup trackGroup, int... iArr) {
        this(comparator, trackGroup, iArr, 0);
    }

    public BaseTrackSelection(TrackGroup trackGroup, int[] iArr, int i) {
        this(null, trackGroup, iArr, i);
    }

    public BaseTrackSelection(Comparator<Format> comparator, TrackGroup trackGroup, int[] iArr, int i) {
        int i2 = 0;
        ...
        if (comparator != null) {
            Arrays.sort(this.formats, comparator);
        } else {
