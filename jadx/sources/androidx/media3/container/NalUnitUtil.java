...
public final class NalUnitUtil {
    ...
    public static int unescapeStream(byte[] bArr, int i) {
        ...
        synchronized (scratchEscapePositionsLock) {
            ...
            int i7 = 0;
            while (i5 < i4) {
                int i8 = scratchEscapePositions[i5] - i6;
    ...
    */
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (parsableNalUnitBitArray.readBit()) {
                    ...
                    i17 = ColorInfo.isoTransferCharacteristicsToColorTransfer(readBits9);
                    i6 = isoColorPrimariesToColorSpace;
                } else {
                    i6 = -1;
                }
            } else {
    ...
    private static void skipScalingList(ParsableNalUnitBitArray parsableNalUnitBitArray, int i) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            if (i2 != 0) {
                i2 = ((parsableNalUnitBitArray.readSignedExpGolombCodedInt() + i3) + JSONzip.end) % JSONzip.end;
            }
            if (i2 != 0) {
                i3 = i2;
            }
