...
public abstract class Timeline implements Bundleable {
    ...
    public static final class Window implements Bundleable {
        ...
        public int hashCode() {
            ...
            return ((((((((((((((((((((((((((((hashCode + 217) * 31) + hashCode2) * 31) + hashCode3) * 31) + hashCode4) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + i) * 31) + ((int) (j3 ^ (j3 >>> 32)))) * 31) + (z ? 1 : 0)) * 31) + (z2 ? 1 : 0)) * 31) + (z3 ? 1 : 0)) * 31) + ((int) (j4 ^ (j4 >>> 32)))) * 31) + ((int) (j5 ^ (j5 >>> 32)))) * 31) + i2) * 31) + i3) * 31) + ((int) ((j6 >>> 32) ^ j6));
        }
    ...
    public static final class Period implements Bundleable {
        ...
        public int hashCode() {
            ...
            return ((((((((((((hashCode + 217) * 31) + hashCode2) * 31) + i) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + ((int) ((j2 >>> 32) ^ j2))) * 31) + (this.isPlaceholder ? 1 : 0)) * 31) + this.adPlaybackState.hashCode();
        }
    ...
    public int hashCode() {
        ...
        while (firstWindowIndex != -1) {
            ...
            if (hashSet.contains(Integer.valueOf(firstWindowIndex))) {
                break;
            }
            hashSet.add(Integer.valueOf(firstWindowIndex));
