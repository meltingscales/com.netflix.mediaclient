...
public final class ListenerSet<T> {
    ...
    /* renamed from: queueEvent */
    public void lambda$queueEvent$0(final int i, final Event<T> event) {
        if (Looper.myLooper() != this.handler.getLooper()) {
            this.handler.post(new Runnable() { // from class: androidx.media3.common.util.ListenerSet$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ListenerSet.this.lambda$queueEvent$0(i, event);
                }
            });
            return;
        }
        final CopyOnWriteArraySet copyOnWriteArraySet = new CopyOnWriteArraySet(this.listeners);
        this.queuedEvents.add(new Runnable() { // from class: androidx.media3.common.util.ListenerSet$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ListenerSet.lambda$queueEvent$1(copyOnWriteArraySet, i, event);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$queueEvent$1(CopyOnWriteArraySet copyOnWriteArraySet, int i, Event event) {
