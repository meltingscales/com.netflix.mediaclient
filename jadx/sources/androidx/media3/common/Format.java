...
public final class Format implements Bundleable {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            int i6 = this.width;
            int i7 = this.height;
            this.hashCode = ((((((((((((((((((((((((((((((((((((((((((((((((((((((hashCode + 527) * 31) + hashCode2) * 31) + hashCode3) * 31) + i) * 31) + i2) * 31) + i3) * 31) + i4) * 31) + hashCode4) * 31) + hashCode5) * 31) + hashCode6) * 31) + hashCode7) * 31) + i5) * 31) + ((int) this.subsampleOffsetUs)) * 31) + i6) * 31) + i7) * 31) + Float.floatToIntBits(this.frameRate)) * 31) + this.rotationDegrees) * 31) + Float.floatToIntBits(this.pixelWidthHeightRatio)) * 31) + this.stereoMode) * 31) + this.channelCount) * 31) + this.sampleRate) * 31) + this.pcmEncoding) * 31) + this.encoderDelay) * 31) + this.encoderPadding) * 31) + this.accessibilityChannel) * 31) + this.tileCountHorizontal) * 31) + this.tileCountVertical) * 31) + this.cryptoType;
        }
    ...
    public static String toLogString(Format format) {
        ...
        if (format.roleFlags != 0) {
            ...
            if ((format.roleFlags & JSONzip.end) != 0) {
                arrayList2.add("sign");
            }
