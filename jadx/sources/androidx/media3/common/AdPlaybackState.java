...
public final class AdPlaybackState implements Bundleable {
    ...
    public static final class AdGroup implements Bundleable {
        ...
        public int hashCode() {
            ...
            return (((((((((((((i * 31) + i2) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + hashCode) * 31) + hashCode2) * 31) + hashCode3) * 31) + ((int) ((j2 >>> 32) ^ j2))) * 31) + (this.isServerSideInserted ? 1 : 0);
        }
    ...
    public int hashCode() {
        ...
        return (((((((((i * 31) + (obj == null ? 0 : obj.hashCode())) * 31) + ((int) this.adResumePositionUs)) * 31) + ((int) this.contentDurationUs)) * 31) + this.removedAdGroupCount) * 31) + Arrays.hashCode(this.adGroups);
    }
