...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private void processCurrentPacket() {
        ...
        while (true) {
            ...
            if (readBits2 == 0) {
                ...
                int position = this.captionChannelPacketData.getPosition();
                while (this.captionChannelPacketData.getPosition() < (readBits2 * 8) + position) {
    ...
    private void handleG0Character(int i) {
        if (i == 127) {
            ...
            this.currentCueInfoBuilder.append((char) (i & PrivateKeyType.INVALID));
        }
    }
