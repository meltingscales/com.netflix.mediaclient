...
public final class PgsParser implements SubtitleParser {
    ...
    public static final class CueBuilder {
        ...
        private final int[] colors = new int[JSONzip.end];
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                this.colors[readUnsignedByte] = (Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, (int) PrivateKeyType.INVALID) << 8) | (parsableByteArray.readUnsignedByte() << 24) | (Util.constrainValue((int) ((1.402d * d2) + d), 0, (int) PrivateKeyType.INVALID) << 16) | Util.constrainValue((int) (d + (d3 * 1.772d)), 0, (int) PrivateKeyType.INVALID);
            }
            this.colorsSet = true;
        }
            ...
            while (i3 < i2) {
                ...
                if (readUnsignedByte != 0) {
                    ...
                    if (readUnsignedByte2 != 0) {
                        i = ((readUnsignedByte2 & 64) == 0 ? readUnsignedByte2 & 63 : this.bitmapData.readUnsignedByte() | ((readUnsignedByte2 & 63) << 8)) + i3;
