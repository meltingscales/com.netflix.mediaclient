...
public final class DefaultExtractorInput implements ExtractorInput {
    ...
    private byte[] peekBuffer = new byte[AleCryptoBouncyCastle.MAX_RANDOM_BYTES];
    ...
    private void ensureSpaceForPeek(int i) {
        ...
        if (i2 > bArr.length) {
            this.peekBuffer = Arrays.copyOf(this.peekBuffer, Util.constrainValue(bArr.length * 2, AleCryptoBouncyCastle.MAX_RANDOM_BYTES + i2, i2 + 524288));
        }
    }
