...
public final class MotionPhotoMetadata implements Metadata.Entry {
    ...
    public int hashCode() {
        int hashCode = Longs.hashCode(this.photoStartPosition);
        int hashCode2 = Longs.hashCode(this.photoSize);
        int hashCode3 = Longs.hashCode(this.photoPresentationTimestampUs);
        return ((((((((hashCode + 527) * 31) + hashCode2) * 31) + hashCode3) * 31) + Longs.hashCode(this.videoStartPosition)) * 31) + Longs.hashCode(this.videoSize);
    }
