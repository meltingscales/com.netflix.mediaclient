...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    */
    private static boolean validateFrames(androidx.media3.common.util.ParsableByteArray r20, int r21, int r22, boolean r23) {
        /*
            r1 = r20
            r0 = r21
            int r2 = r20.getPosition()
        L8:
            int r3 = r20.bytesLeft()     // Catch: java.lang.Throwable -> Lb1
            r4 = 1
            r5 = r22
            if (r3 < r5) goto Lad
            r3 = 3
            r6 = 0
            if (r0 < r3) goto L22
            int r7 = r20.readInt()     // Catch: java.lang.Throwable -> Lb1
            long r8 = r20.readUnsignedInt()     // Catch: java.lang.Throwable -> Lb1
            int r10 = r20.readUnsignedShort()     // Catch: java.lang.Throwable -> Lb1
            goto L2c
        L22:
            int r7 = r20.readUnsignedInt24()     // Catch: java.lang.Throwable -> Lb1
            int r8 = r20.readUnsignedInt24()     // Catch: java.lang.Throwable -> Lb1
            long r8 = (long) r8
            r10 = r6
        L2c:
            r11 = 0
        ...
        La7:
            int r3 = (int) r8
            r1.skipBytes(r3)     // Catch: java.lang.Throwable -> Lb1
            goto L8
        Lad:
            r1.setPosition(r2)
            return r4
    ...
    */
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) {
        ...
        byte b = bArr[indexOfZeroByte + 1];
        int i4 = indexOfZeroByte + 2;
        int indexOfTerminator = indexOfTerminator(bArr, i4, readUnsignedByte);
        return new ApicFrame(str, new String(bArr, i4, indexOfTerminator - i4, charset), b & 255, copyOfRangeIfValid(bArr, indexOfTerminator + delimiterLength(readUnsignedByte), i3));
    }
