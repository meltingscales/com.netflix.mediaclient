...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void updateStateFromTypedArray(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme) {
        ...
        if (vPathRenderer.mViewportWidth <= 0.0f) {
            ...
            if (vPathRenderer.mBaseWidth <= 0.0f) {
                ...
                vPathRenderer.setAlpha(TypedArrayUtils.getNamedFloat(typedArray, xmlPullParser, InteractiveAnimation.ANIMATION_TYPE.ALPHA, 4, vPathRenderer.getAlpha()));
    ...
    public static class VGroup extends VObject {
        ...
        private void updateStateFromTypedArray(TypedArray typedArray, XmlPullParser xmlPullParser) {
            ...
            this.mRotate = TypedArrayUtils.getNamedFloat(typedArray, xmlPullParser, InteractiveAnimation.ANIMATION_TYPE.ROTATION, 5, this.mRotate);
