...
public final class NavOptions {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !C8632dsu.c(NavOptions.class, obj.getClass())) {
            return false;
        }
        NavOptions navOptions = (NavOptions) obj;
        return this.singleTop == navOptions.singleTop && this.restoreState == navOptions.restoreState && this.popUpToId == navOptions.popUpToId && C8632dsu.c((Object) this.popUpToRoute, (Object) navOptions.popUpToRoute) && this.popUpToInclusive == navOptions.popUpToInclusive && this.popUpToSaveState == navOptions.popUpToSaveState && this.enterAnim == navOptions.enterAnim && this.exitAnim == navOptions.exitAnim && this.popEnterAnim == navOptions.popEnterAnim && this.popExitAnim == navOptions.popExitAnim;
    }

    public int hashCode() {
        boolean shouldLaunchSingleTop = shouldLaunchSingleTop();
        boolean shouldRestoreState = shouldRestoreState();
        int i = this.popUpToId;
        String str = this.popUpToRoute;
        return ((((((((((((((((((shouldLaunchSingleTop ? 1 : 0) * 31) + (shouldRestoreState ? 1 : 0)) * 31) + i) * 31) + (str != null ? str.hashCode() : 0)) * 31) + (isPopUpToInclusive() ? 1 : 0)) * 31) + (shouldPopUpToSaveState() ? 1 : 0)) * 31) + this.enterAnim) * 31) + this.exitAnim) * 31) + this.popEnterAnim) * 31) + this.popExitAnim;
    }
