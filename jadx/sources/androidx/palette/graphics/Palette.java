...
public final class Palette {
    ...
    public static final class Swatch {
        ...
        private void ensureTextColorsGenerated() {
            ...
            int calculateMinimumAlpha3 = ColorUtils.calculateMinimumAlpha(ArtworkColors.DEFAULT_BACKGROUND_COLOR, this.mRgb, 4.5f);
            int calculateMinimumAlpha4 = ColorUtils.calculateMinimumAlpha(ArtworkColors.DEFAULT_BACKGROUND_COLOR, this.mRgb, 3.0f);
            if (calculateMinimumAlpha3 != -1 && calculateMinimumAlpha4 != -1) {
                this.mBodyTextColor = ColorUtils.setAlphaComponent(ArtworkColors.DEFAULT_BACKGROUND_COLOR, calculateMinimumAlpha3);
                this.mTitleTextColor = ColorUtils.setAlphaComponent(ArtworkColors.DEFAULT_BACKGROUND_COLOR, calculateMinimumAlpha4);
                this.mGeneratedTextColors = true;
                return;
            }
            if (calculateMinimumAlpha != -1) {
                ...
                alphaComponent = ColorUtils.setAlphaComponent(ArtworkColors.DEFAULT_BACKGROUND_COLOR, calculateMinimumAlpha3);
            }
            ...
            if (calculateMinimumAlpha2 != -1) {
                ...
                alphaComponent2 = ColorUtils.setAlphaComponent(ArtworkColors.DEFAULT_BACKGROUND_COLOR, calculateMinimumAlpha4);
            }
