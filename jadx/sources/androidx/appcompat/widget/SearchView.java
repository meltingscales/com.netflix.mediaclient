...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private static byte e$ss2$8255;
        ...
        if (i3 % 2 != 0) {
            ...
            if (r1 == 0) {
                ...
                if (searchableInfo == null || searchableInfo.getHintId() == 0) {
                    ...
                    String string = context.getString(hintId);
                    if (string.startsWith("'!#+")) {
                        ...
                        CharSequence text = context.getText(hintId);
    ...
    private boolean hasVoiceSearch() {
        ...
        if (searchableInfo != null && searchableInfo.getVoiceSearchEnabled()) {
            ...
            if (intent != null && getContext().getPackageManager().resolveActivity(intent, AleCryptoBouncyCastle.MAX_RANDOM_BYTES) != null) {
                return true;
            }
        }
        return false;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x00af, code lost:
        if (r13.startsWith("'!#+") != false) goto L40;
     */
    ...
    */
    private android.content.Intent createVoiceAppSearchIntent(android.content.Intent r17, android.app.SearchableInfo r18) {
        /*
    ...
    private static void b(String str, Object[] objArr) {
        ...
        for (int i = 0; i < decode.length; i++) {
            bArr[i] = (byte) (decode[(decode.length - i) - 1] ^ e$ss2$8255);
        }
