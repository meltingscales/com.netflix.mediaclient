...
public final class Key {
    ...
    private static final long f13087J = Key_androidKt.Key(38);
    ...
    private static final long Function = Key_androidKt.Key(NetflixImageView.DEFAULT_LAYER_GRAVITY);
    ...
    private static final long TvZoomMode = Key_androidKt.Key(PrivateKeyType.INVALID);
    private static final long TvContentsMenu = Key_androidKt.Key(JSONzip.end);
    ...
    public static final /* synthetic */ Key m1625boximpl(long j) {
        return new Key(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1626constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1627equalsimpl(long j, Object obj) {
        return (obj instanceof Key) && j == ((Key) obj).m1631unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1627equalsimpl(this.keyCode, obj);
    }

    public int hashCode() {
        return m1629hashCodeimpl(this.keyCode);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1631unboximpl() {
        return this.keyCode;
    }
    ...
    public static final class Companion {
        ...
        public final long m1632getBackEK5gGoQ() {
            return Key.Back;
        }

        /* renamed from: getDirectionUp-EK5gGoQ  reason: not valid java name */
        public final long m1637getDirectionUpEK5gGoQ() {
            return Key.DirectionUp;
        }

        /* renamed from: getDirectionDown-EK5gGoQ  reason: not valid java name */
        public final long m1634getDirectionDownEK5gGoQ() {
            return Key.DirectionDown;
        }

        /* renamed from: getDirectionLeft-EK5gGoQ  reason: not valid java name */
        public final long m1635getDirectionLeftEK5gGoQ() {
            return Key.DirectionLeft;
        }

        /* renamed from: getDirectionRight-EK5gGoQ  reason: not valid java name */
        public final long m1636getDirectionRightEK5gGoQ() {
            return Key.DirectionRight;
        }

        /* renamed from: getDirectionCenter-EK5gGoQ  reason: not valid java name */
        public final long m1633getDirectionCenterEK5gGoQ() {
            return Key.DirectionCenter;
        }

        /* renamed from: getTab-EK5gGoQ  reason: not valid java name */
        public final long m1643getTabEK5gGoQ() {
            return Key.Tab;
        }

        /* renamed from: getEnter-EK5gGoQ  reason: not valid java name */
        public final long m1638getEnterEK5gGoQ() {
            return Key.Enter;
        }

        /* renamed from: getEscape-EK5gGoQ  reason: not valid java name */
        public final long m1639getEscapeEK5gGoQ() {
            return Key.Escape;
        }

        /* renamed from: getPageUp-EK5gGoQ  reason: not valid java name */
        public final long m1642getPageUpEK5gGoQ() {
            return Key.PageUp;
        }

        /* renamed from: getPageDown-EK5gGoQ  reason: not valid java name */
        public final long m1641getPageDownEK5gGoQ() {
            return Key.PageDown;
        }

        /* renamed from: getNumPadEnter-EK5gGoQ  reason: not valid java name */
        public final long m1640getNumPadEnterEK5gGoQ() {
    ...
    public static String m1630toStringimpl(long j) {
        return "Key code: " + j;
    }

    public String toString() {
        return m1630toStringimpl(this.keyCode);
    }
}
