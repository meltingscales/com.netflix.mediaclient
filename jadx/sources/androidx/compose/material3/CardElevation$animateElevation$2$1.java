...
public final class CardElevation$animateElevation$2$1 extends SuspendLambda implements drX<dwU, InterfaceC8585dra<? super dpR>, Object> {
    ...
    public CardElevation$animateElevation$2$1(Animatable<Dp, AnimationVector1D> animatable, float f, boolean z, CardElevation cardElevation, Interaction interaction, InterfaceC8585dra<? super CardElevation$animateElevation$2$1> interfaceC8585dra) {
    ...
    public final InterfaceC8585dra<dpR> create(Object obj, InterfaceC8585dra<?> interfaceC8585dra) {
        return new CardElevation$animateElevation$2$1(this.$animatable, this.$target, this.$enabled, this.this$0, this.$interaction, interfaceC8585dra);
    }

    @Override // o.drX
    public final Object invoke(dwU dwu, InterfaceC8585dra<? super dpR> interfaceC8585dra) {
        return ((CardElevation$animateElevation$2$1) create(dwu, interfaceC8585dra)).invokeSuspend(dpR.c);
    }
        ...
        if (i == 0) {
            ...
            if (!Dp.m2494equalsimpl0(this.$animatable.getTargetValue().m2498unboximpl(), this.$target)) {
                if (!this.$enabled) {
                    ...
                    if (Dp.m2494equalsimpl0(m2498unboximpl, f)) {
                        ...
                        if (Dp.m2494equalsimpl0(m2498unboximpl, f2)) {
                            ...
                            if (Dp.m2494equalsimpl0(m2498unboximpl, f3)) {
                                ...
                                if (Dp.m2494equalsimpl0(m2498unboximpl, f4)) {
                    ...
                    this.label = 2;
                    if (ElevationKt.m785animateElevationrAjV9yQ(animatable2, f5, interaction, interaction2, this) == e) {
                        return e;
                    }
                }
            }
