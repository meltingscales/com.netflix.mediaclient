...
public final class ComposeErrorMessages implements DefaultErrorMessages.Extension {
    ...
    public ComposeErrorMessages() {
        ...
        diagnosticFactoryToRendererMap.put(ComposeErrors.ABSTRACT_COMPOSABLE_DEFAULT_PARAMETER_VALUE, "Overridable Composable functions with default values are not currently supported");
