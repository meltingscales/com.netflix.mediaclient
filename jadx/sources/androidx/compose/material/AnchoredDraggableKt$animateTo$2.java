...
public final class AnchoredDraggableKt$animateTo$2<T> extends SuspendLambda implements InterfaceC8613dsb<AnchoredDragScope, DraggableAnchors<T>, T, InterfaceC8585dra<? super dpR>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!Float.isNaN(positionOf)) {
                ...
                drX<Float, Float, dpR> drx = new drX<Float, Float, dpR>() { // from class: androidx.compose.material.AnchoredDraggableKt$animateTo$2.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(2);
                    }
