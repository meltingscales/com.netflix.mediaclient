...
public final class MinimumInteractiveModifierNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutModifierNode {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final int i2 = height;
        return MeasureScope.layout$default(measureScope, i, i2, null, new drM<Placeable.PlacementScope, dpR>() { // from class: androidx.compose.material.MinimumInteractiveModifierNode$measure$1
