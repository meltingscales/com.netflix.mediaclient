...
public final class ContentAlpha {
    ...
    private final float contentAlpha(float f, float f2, Composer composer, int i) {
        ...
        long m1302unboximpl = ((Color) composer.consume(ContentColorKt.getLocalContentColor())).m1302unboximpl();
        if (!MaterialTheme.INSTANCE.getColors(composer, 6).isLight() ? ColorKt.m1316luminance8_81llA(m1302unboximpl) >= 0.5d : ColorKt.m1316luminance8_81llA(m1302unboximpl) <= 0.5d) {
            f = f2;
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
