                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        if (match >= 0) {
                            ...
                            Log.v("LocalBroadcastManager", "  Filter did not match: " + (match != -4 ? match != -3 ? match != -2 ? match != -1 ? "unknown reason" : "type" : NotificationFactory.DATA : SignupConstants.Error.DEBUG_INFO_ACTION : "category"));
                        }
                    }
