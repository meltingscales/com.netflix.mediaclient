...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3 {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                ...
                childAt.measure(ViewGroup.getChildMeasureSpec(i, paddingLeft + paddingRight + i3 + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, 1073741824));
            }
        }
    }
    ...
    private boolean shouldAbsorb(EdgeEffect edgeEffect, int i) {
        return i > 0 || getSplineFlingDistance(-i) < EdgeEffectCompat.getDistance(edgeEffect) * ((float) getHeight());
    }
    ...
    private float getSplineFlingDistance(int i) {
        ...
        return (float) (this.mPhysicalCoeff * 0.015f * Math.exp((d / (d - 1.0d)) * log));
    }
    ...
    protected void measureChildWithMargins(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(ViewGroup.getChildMeasureSpec(i, paddingLeft + paddingRight + i5 + marginLayoutParams.rightMargin + i2, marginLayoutParams.width), View.MeasureSpec.makeMeasureSpec(marginLayoutParams.topMargin + marginLayoutParams.bottomMargin, 0));
    }
