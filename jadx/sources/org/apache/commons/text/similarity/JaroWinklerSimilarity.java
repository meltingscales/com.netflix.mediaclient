...
public class JaroWinklerSimilarity {
    final int prefixLengthLimit;

    public JaroWinklerSimilarity() {
        this(4);
    }

    public JaroWinklerSimilarity(int i) {
    ...
    protected int[] matches(CharSequence charSequence, CharSequence charSequence2) {
        ...
        int i9 = 0;
        for (int i10 = 0; i10 < Math.min(this.prefixLengthLimit, charSequence3.length()) && charSequence.charAt(i10) == charSequence2.charAt(i10); i10++) {
            i9++;
        }
