...
public class TKEYRecord extends Record {
    ...
    protected void rrFromWire(DNSInput dNSInput) {
        ...
        this.timeInception = Instant.d(dNSInput.readU32());
        this.timeExpire = Instant.d(dNSInput.readU32());
    ...
    protected void rrToWire(DNSOutput dNSOutput, Compression compression, boolean z) {
        ...
        dNSOutput.writeU32(this.timeInception.d());
        dNSOutput.writeU32(this.timeExpire.d());
