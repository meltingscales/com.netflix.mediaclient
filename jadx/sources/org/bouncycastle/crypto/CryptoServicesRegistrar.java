...
public final class CryptoServicesRegistrar {
    ...
    /* loaded from: classes5.dex */
    static class ThreadLocalSecureRandomProvider implements SecureRandomProvider {
    ...
    private static int chooseLowerBound(int i) {
        if (i > 1024) {
            ...
            return i <= 3072 ? JSONzip.end : i <= 7680 ? 384 : 512;
        }
        return 160;
    }
    ...
    public static SecureRandom getSecureRandom() {
        ...
        MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, defaultRandomProviderImpl);
