...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    protected void processBlock() {
        ...
        int RL287 = RL(((RL282 + f5(RL285, RL283, RL286)) + this.X[13]) - 1454113458, 6);
        ...
        int RL319 = RL(RL314 + f1(RL317, RL315, RL318) + this.X[11], 11);
        int RL320 = RL(RL315, 10);
        int i6 = this.H1;
        this.H1 = this.H2 + RL288 + RL318;
        this.H2 = this.H3 + RL286 + RL316;
        this.H3 = this.H4 + RL284 + RL319 + RL316;
        this.H4 = this.H0 + RL287 + RL284 + RL317;
        this.H0 = RL320 + RL285 + i6;
        this.xOff = 0;
        int i7 = 0;
        while (true) {
            int[] iArr = this.X;
