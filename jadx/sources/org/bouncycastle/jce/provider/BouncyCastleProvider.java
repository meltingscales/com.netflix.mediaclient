...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static final CryptoServiceProperties[] SYMMETRIC_CIPHERS = {service("AES", JSONzip.end), service("ARC4", 20), service("ARIA", JSONzip.end), service("Blowfish", 128), service("Camellia", JSONzip.end), service("CAST5", 128), service("CAST6", JSONzip.end), service("ChaCha", 128), service("DES", 56), service("DESede", 112), service("GOST28147", 128), service("Grainv1", 128), service("Grain128", 128), service("HC128", 128), service("HC256", JSONzip.end), service("IDEA", 128), service("Noekeon", 128), service("RC2", 128), service("RC5", 128), service("RC6", JSONzip.end), service("Rijndael", JSONzip.end), service("Salsa20", 128), service("SEED", 128), service("Serpent", JSONzip.end), service("Shacal2", 128), service("Skipjack", 80), service("SM4", 128), service("TEA", 128), service("Twofish", JSONzip.end), service("Threefish", 128), service("VMPC", 128), service("VMPCKSA3", 128), service("XTEA", 128), service("XSalsa20", 128), service("OpenSSLPBKDF", 128), service("DSTU7624", JSONzip.end), service("GOST3412_2015", JSONzip.end), service("Zuc", 128)};
    private static final String[] ASYMMETRIC_GENERIC = {"X509", "IES", "COMPOSITE", "EXTERNAL"};
    private static final String[] ASYMMETRIC_CIPHERS = {"DSA", "DH", "EC", AleCryptoBouncyCastle.RSA_KEY_ALG, "GOST", "ECGOST", "ElGamal", "DSTU4145", "GM", "EdEC", "LMS", "SPHINCSPlus", "Dilithium", "Falcon", "NTRU"};
