...
public class SecT233Field {
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        while (i2 < i) {
            ...
            int i4 = i3 >>> 6;
            int i5 = i3 & 63;
            createExt64[i4] = createExt64[i4] ^ (j5 << i5);
            int i6 = i4 + 1;
            int[] iArr2 = iArr;
            int i7 = -i5;
            createExt64[i6] = createExt64[i6] ^ ((j4 << i5) | (j5 >>> i7));
            int i8 = i4 + 2;
            createExt64[i8] = createExt64[i8] ^ ((j3 << i5) | (j4 >>> i7));
            i = 3;
            int i9 = i4 + 3;
            createExt64[i9] = createExt64[i9] ^ (j3 >>> i7);
            i2++;
            iArr = iArr2;
        }
        reduce(createExt64, jArr2);
