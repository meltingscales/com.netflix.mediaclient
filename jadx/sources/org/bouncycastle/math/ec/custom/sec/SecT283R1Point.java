...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply4.isZero()) {
                return new SecT283R1Point(curve, multiply4, curve.getB().sqrt());
            }
        ...
        return new SecT283R1Point(curve, eCFieldElement4, squarePlusProduct, new ECFieldElement[]{multiply});
    }
